...
const handlerLogin=async(req,res)=>{
   ...
   // const founderUser=usersDB.users.find(person=>person.username===user);
    ...
    if(match){
        ...
        //at sigh() u dont want to pass in password to guid agaisnt snifing of ur password .. username is prefered
     ...
     */
     ...
     res.status(200).json({'success':`User ${user} is logged in!`,accessToken,'expires':date.addSeconds(now,300)});
